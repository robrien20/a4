    ...
    function handleMouseOver(d, i) { //d: data in format {month, value}, i: index
      ...
      d3.select(".text--info").html(info[i]['park'].toString() + "<br>") //display name of park at bottom
          .append("text")
              ...
              .html( "<div class=\"padded-multiline\"><h1><strong>" + "Number of acres: " + info[i]['acres'].toLocaleString() + "<br>" + "        " + "Peak visitation month: " + info[i]['peak visitation'] + "</strong></h1></div><br>")
          .append("text")
